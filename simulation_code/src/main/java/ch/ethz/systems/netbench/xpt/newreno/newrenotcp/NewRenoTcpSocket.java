...
public class NewRenoTcpSocket extends Socket {
    ...
    // Loss window
    protected long LOSS_WINDOW_SIZE;

    private final long rto_min = 0;
    private final long rto_max = 32384;
    // private final long rto_max = 96384L;
    ...
    // * CHANGE HERE TODO: delete the sid and did;
    public int sid, did;
    ////////////////////////////////////////////////////////
    /// TCP IMPLEMENTATION
     ...
     */
    public NewRenoTcpSocket(TransportLayer transportLayer, long flowId, int sourceId, int destinationId, long flowSizeByte, int sourcePort, int destinationPort) {
        ...
        // CHANGE HERE
        // System.out.println("rto:" + this.roundTripTimeout);
        ...
        // this.MAX_WINDOW_SIZE = Simulator.getConfiguration().getLongPropertyWithDefault("TCP_MAX_WINDOW_SIZE", 65535000L);
    ...
    private void handleAcknowledgment(FullExtTcpPacket packet) {
        ...
        // TODO: delete
        if (roundTripTimeout < this.rto_min) 
            roundTripTimeout = this.rto_min;
        // this.roundTripTimeout = 66384L;
        // if (roundTripTimeout > this.rto_max) 
        //     roundTripTimeout = this.rto_max;
        // System.out.println("RECV rto: " + this.roundTripTimeout);
    ...
    */
    ...
    private void resetRetransmissionTimeOutTimer() {
        ...
        // If there is outstanding data, reset timer
            ...
            // System.out.println("register a event with timeout:" + roundTripTimeout);
    ...
    public void handleRetransmissionTimeOut() {
        ...
        // if (roundTripTimeout > this.rto_max) 
        //     roundTripTimeout = this.rto_max;
        // System.out.println("LOSS rto: " + this.roundTripTimeout);
