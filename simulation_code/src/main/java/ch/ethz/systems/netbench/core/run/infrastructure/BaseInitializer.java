...
public class BaseInitializer {
    ...
    private final TransportLayerGenerator secondTransportLayerGenerator;
    ...
    public BaseInitializer(
            ...
            TransportLayerGenerator secondTransportLayerGenerator
    ) {
        ...
        this.secondTransportLayerGenerator = secondTransportLayerGenerator;
...
//            if (((id == 8) || (id == 9) || (id == 10) || (id == 14)) || (id == 8 + 16) || (id == 9 + 16) || (id == 10 + 16) || (id == 14 + 16)) {
//            if ((id <= 7) || ((id >=16) && (id<=23))) {
//                transportLayer = secondTransportLayerGenerator.generate(id);
//            }
//            else {
//            else if (((id == 11) || (id == 12) || (id == 13) || (id == 15)) || (id == 11+ 16) || (id == 12+ 16) || (id == 13+ 16) || (id == 15+ 16)) {
//            if ((id >=144) && (id <= 287)) {
//                transportLayer = secondTransportLayerGenerator.generate(id);
//            }
//            else {
                transportLayer = transportLayerGenerator.generate(id);
//            }
//            }
